<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="sualoaisp.aspx.cs" Inherits="QuanLyWebQuanAoMixi.Admin.adLoaiSanPham.sualoaisp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentadmin1" runat="server">
    ...
    <div style="width: 1000px; margin-left: 200px; margin-top: 50px">
        ...
        <div>
            <asp:Button CssClass="btn btn-primary" ID="btnsua" runat="server" Text="Lưu" OnClick="btnsua_Click"/>
        </div>
    </div>
</asp:Content>
